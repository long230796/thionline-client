...
public class QuanLiBodeView extends JFrame {
	...
	public QuanLiBodeView(Permission auth, List<Cauhoi> listCauhoi, Proxy proxy) {
...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		JLabel lblNewLabel = new JLabel("Quản lí bộ đề");
		...
		panel_1.setBounds(10, 72, 727, 173);
		contentPane.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblNewLabel_1 = new JLabel("Thông tin đề thi");
		lblNewLabel_1.setFont(new Font("Arial", Font.PLAIN, 14));
		lblNewLabel_1.setForeground(new Color(0, 0, 255));
		lblNewLabel_1.setBounds(10, 10, 153, 15);
		panel_1.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Trình độ");
		lblNewLabel_2.setFont(new Font("Arial", Font.BOLD, 12));
		lblNewLabel_2.setBounds(44, 33, 91, 22);
		...
		JLabel lblNewLabel_2_1 = new JLabel("Nội dung");
		lblNewLabel_2_1.setFont(new Font("Arial", Font.BOLD, 12));
		lblNewLabel_2_1.setBounds(403, 33, 80, 22);
		...
		lblNewLabel_2_2.setBounds(44, 65, 91, 22);
		...
		JLabel lblNewLabel_2_2_1_1 = new JLabel("Đáp án");
		lblNewLabel_2_2_1_1.setFont(new Font("Arial", Font.BOLD, 12));
		lblNewLabel_2_2_1_1.setBounds(44, 129, 91, 22);
		...
		panel_2.setBounds(10, 255, 727, 308);
		...
		btnNewButton_1.addActionListener(new XoaDethi());
		
		JButton btnNewButton_2 = new JButton("Sửa");
		btnNewButton_2.addActionListener(new SuaDethi());
		...
		JLabel lblNewLabel_3 = new JLabel("Bảng đề thi");
		...
		jTable.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
	        public void valueChanged(ListSelectionEvent event) {
	        	made = jTable.getValueAt(jTable.getSelectedRow(), 0).toString();
			...
			if (made != null) {
				...
				if(dialogResult == JOptionPane.YES_OPTION){
					...
					if (!new String("null").equals(response)) {
						...
						List<Cauhoi> cauhoiUpdate = ctrl.getListCauhoi();
						QuanLiBodeView qldethi = new QuanLiBodeView(auth, cauhoiUpdate, proxy);
						current.dispose();
				...
				JOptionPane.showMessageDialog(null, "Bạn chưa chọn câu hỏi");
			}
		}
	}
	
	class SuaDethi implements ActionListener {
		public void actionPerformed( ActionEvent e ) {
			if (made != null) {
				int dialogResult = JOptionPane.showConfirmDialog (null, "Bạn có muốn sửa không?", "Warning", 0);
				if(dialogResult == JOptionPane.YES_OPTION){
					Cauhoi quest = new Cauhoi(made, textField.getText(), textField_1.getText(), textField_2.getText(), textField_3.getText(), textField_4.getText(), textField_5.getText(), textField_6.getText());
					List<Cauhoi> listCauhoi = new ArrayList<Cauhoi>();
					listCauhoi.add(quest);
					CauhoiPackage cauhoiPkg = new CauhoiPackage(auth, listCauhoi, 0);
					
					String request = "SuaCauhoi_" + gson.toJson(cauhoiPkg);
					String response = proxy.sender(request);
